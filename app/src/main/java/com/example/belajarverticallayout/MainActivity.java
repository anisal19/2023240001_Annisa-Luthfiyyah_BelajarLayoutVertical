package com.example.belajarverticallayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BtnBukaSatu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent BukaActSatu = new Intent(getApplicationContext(), ChildrenColumn.class);
        ...
        BtnBukaTiga.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent BukaActTiga = new Intent(getApplicationContext(), LeftOverHigh.class);
